    ...
    <main className='mt-17 mb-20'>
      ...
      <section className='mt-24 px-4 md:px-20'>
        ...
        <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div className='border border-gray-300 p-10 flex flex-col gap-4 text-center items-center hover:shadow-md transition-shadow cursor-default'>
            <h2 className='font-bold text-gray-900'>Quality Assurance:</h2>
          ...
          <div className='border border-gray-300 p-10 flex flex-col gap-4 text-center items-center hover:shadow-md transition-shadow cursor-default'>
            <h2 className='font-bold text-gray-900'>Convenience:</h2>
            <p className='text-gray-600 text-sm'>
          ...
          <div className='border border-gray-300 p-10 flex flex-col gap-4 text-center items-center hover:shadow-md transition-shadow cursor-default'>
            <h2 className='font-bold text-gray-900'>Exceptional Customer Service:</h2>
            <p className='text-gray-600 text-sm'>
